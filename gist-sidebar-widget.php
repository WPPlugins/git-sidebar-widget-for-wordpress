<?php
/*
  Plugin Name: GitHub Gists Sidebar Widget For Wordpress
  Plugin URI:http://haoqis.com/tag/wp-plugins
  Description: A sidebar widget to display your public gists from GitHub.(Based on norcross's 1.0.0 version)
  Version: 1.0.1
  Author: haoqisir 
...
if(!function_exists('rkv_gist_widget_css')) {
 ...
 * construct widget
 */
class hrkv_ListGistsWidget extends WP_Widget {

    /** constructor */
    function hrkv_ListGistsWidget() {
...
// class 
// register widget
add_action('widgets_init', 'hrkv_ListGistsWidget_init');

function hrkv_ListGistsWidget_init() {
    add_filter('https_local_ssl_verify', create_function('', 'return false;'));
    add_filter('https_ssl_verify', create_function('', 'return false;'));
    register_widget('hrkv_ListGistsWidget');
}